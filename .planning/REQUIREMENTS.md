...
- [x] **INDICF5-06**: Unit tests in `tests/test_tts_indicf5.py` mock the heavy model and cover: happy path, missing ref_audio, empty ref_text, output path creation
